...
class ClientRetryAfterTest extends Test {
    private function makeClient(?HttpClient $httpClient = null): RetryAfterTestClient {
        return new RetryAfterTestClient('https://api.example.com', null, false, $httpClient);
    }
...
class RetryAfterTestClient extends ClientAbstract {
